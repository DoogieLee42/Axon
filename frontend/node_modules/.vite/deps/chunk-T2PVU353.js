...
var PopperTooltip = React70.forwardRef(function PopperTooltip2(props, forwardedRef) {
  var _slots$root;
  const {
    anchorEl,
    children: children2,
  ...
  const tooltipRef = React70.useRef(null);
  const ownRef = useForkRef(tooltipRef, forwardedRef);
  const popperRef = React70.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React70.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React70.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React70.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React70.useState(resolveAnchorEl2(anchorEl));
  React70.useEffect(() => {
...
var Popper = React70.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children: children2,
    container: containerProp,
  ...
  return (0, import_jsx_runtime67.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime67.jsx)(PopperTooltip, _extends({
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
var Popper3 = React71.forwardRef(function Popper4(inProps, ref) {
  ...
  return (0, import_jsx_runtime68.jsx)(PopperRoot, _extends({
    as: component,
...
var ListItem = React78.forwardRef(function ListItem2(inProps, ref) {
  ...
  const children2 = React78.Children.toArray(childrenProp);
...
true ? ListItem.propTypes = {
  ...
  children: chainPropTypes(import_prop_types64.default.node, (props) => {
    const children2 = React78.Children.toArray(props.children);
...
var Chip = React80.forwardRef(function Chip2(inProps, ref) {
  ...
  const ownerState = _extends({}, props, {
    ...
    size,
    color,
    iconColor: React80.isValidElement(iconProp) ? iconProp.props.color || color : color,
    onDelete: !!onDelete,
    clickable,
    variant
  });
...
var Tab = React81.forwardRef(function Tab2(inProps, ref) {
  ...
  return (0, import_jsx_runtime79.jsxs)(TabRoot, _extends({
    ...
    children: [iconPosition === "top" || iconPosition === "start" ? (0, import_jsx_runtime79.jsxs)(React81.Fragment, {
      children: [icon, label]
    }) : (0, import_jsx_runtime79.jsxs)(React81.Fragment, {
      children: [label, icon]
    }), indicator]
  }));
});
...
var _excluded59 = ["className", "slots", "slotProps", "direction", "orientation", "disabled"];
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-T2PVU353.js.map
